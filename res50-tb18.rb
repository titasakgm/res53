...
#TABLE 18 DOCTORS|DENTISTS|PHARMACISTS|PN|TN รพศ. By Pak

require 'postgres'

#Get info
con = PGconn.connect("localhost",5432,nil,nil,"resource50")
sql = "select * from v_tb18_f1 order by pak"
res = con.exec(sql)

html = "<html>\n"
html += "<head>\n"
html += "<title>TABLE 18</title>\n"
html += "</head>\n"
html += "<body>\n"
html += "<h4>ตาราง 18 จำนวนบุคลากรทางการแพทย์ รพศ. รายภาค ปี 2550</h4>\n"
...
File.open("/res53/res50-tb18.html","w").write(html)
